...
From the workflow step `Deploy Cloud Run` copy out url `https://redis-__________run.app` of the invoke endpoint:

```
Invoke endpoint:
https://redis-__________run.app
```

Call the api endpoint:

```
curl https://redis-__________run.app/redis
```
